...
<section className="services-intro">
              ...
              {Array(4).fill(0).map((_, index) => (
                <div key={index} className="service-item">
                  <div className="service-icon">
                    <img src="/ProjectAsset/lettering-3d-text-3.png" alt="3D Services" />
                  </div>
      ...
      <section className="testimonials-section">
        <div className="testimonials-bg">
          ...
          <img src="/ProjectAsset/polygon-1-68.svg" alt="Polygon" className="polygon-right" />
          <img src="/ProjectAsset/polygon-1.svg" alt="Polygon" className="polygon-left" />
        </div>
